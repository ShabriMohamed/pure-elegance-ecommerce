...
<div class="grid md-grid-cols-2 gap-4" style="margin-bottom: var(--space-2xl);">
    <div class="card" style="padding: var(--space-lg); border: none; background: var(--color-cream);">
        <h3 style="font-size: 1rem; margin-bottom: var(--space-md); color: var(--color-charcoal); display: flex; align-items: center; gap: 0.5rem;">
...
@if($recentOrders->isEmpty())
    <div style="text-align: center; padding: var(--space-xl) 0; background: var(--color-cream); border-radius: var(--radius-sm);">
        <span class="material-symbols-outlined" style="font-size: 3rem; color: var(--color-muted); margin-bottom: var(--space-sm);">shopping_bag</span>
...
@else
    <div style="overflow-x: auto;">
        <table style="width: 100%; border-collapse: collapse;">
            <thead>
                <tr style="border-bottom: 1px solid var(--color-border); color: var(--color-muted); font-size: 0.75rem; text-transform: uppercase; letter-spacing: 1px;">
            ...
            <tbody>
                @foreach($recentOrders as $order)
                    <tr style="border-bottom: 1px solid var(--color-border);">
                        ...
                        <td style="padding: var(--space-md) var(--space-sm); color: var(--color-muted); font-size: 0.875rem;">{{ $order->created_at->format('M d, Y') }}</td>
