...
<div class="admin-card" style="max-width: 700px;">
    <h2 style="font-size: 1.25rem; margin-bottom: var(--space-lg); border-bottom: 1px solid var(--color-border); padding-bottom: var(--space-md);">Create Promotion</h2>
    ...
    <form method="POST" action="{{ route('admin.promotions.store') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="form-control" value="{{ old('name') }}" required placeholder="e.g. Summer Sale 2026">
            @error('name')<div class="form-error">{{ $message }}</div>@enderror
        </div>

        <div class="form-group">
            <label for="code" class="form-label">Promo Code *</label>
            <input type="text" id="code" name="code" class="form-control" value="{{ old('code') }}" required placeholder="e.g. SUMMER20" style="text-transform: uppercase; letter-spacing: 1px; font-weight: 600;">
            <div style="font-size: 0.75rem; color: var(--color-muted); margin-top: 4px;">Customers will enter this code at checkout. Auto-uppercased.</div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-md);">
            ...
            <div class="form-group">
                ...
                <input type="number" id="value" name="value" class="form-control" value="{{ old('value') }}" required min="0" step="0.01" placeholder="e.g. 20">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-md);">
            <div class="form-group">
                ...
                <input type="number" id="min_order_amount" name="min_order_amount" class="form-control" value="{{ old('min_order_amount') }}" min="0" step="0.01" placeholder="e.g. 5000">
                <div style="font-size: 0.75rem; color: var(--color-muted); margin-top: 4px;">Leave empty for no minimum</div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="max_discount_amount" name="max_discount_amount" class="form-control" value="{{ old('max_discount_amount') }}" min="0" step="0.01" placeholder="e.g. 2000">
                <div style="font-size: 0.75rem; color: var(--color-muted); margin-top: 4px;">For percentage discounts</div>
        ...
        <div class="form-group">
            ...
            <input type="number" id="usage_limit" name="usage_limit" class="form-control" value="{{ old('usage_limit') }}" min="1" placeholder="e.g. 100">
            <div style="font-size: 0.75rem; color: var(--color-muted); margin-top: 4px;">Total number of times this code can be used. Leave empty for unlimited.</div>
        ...
        <div style="display: flex; gap: var(--space-md); margin-top: var(--space-lg);">
            <button type="submit" class="btn btn-primary" style="padding: 0.6rem 2rem;">Create Promotion</button>
