...
<div class="admin-card" style="max-width: 800px;">
    ...
    <form method="POST" action="{{ route('admin.settings.store') }}">
        ...
        <div class="grid md-grid-cols-2 gap-4" style="margin-bottom: var(--space-lg);">
            <div class="form-group">
                <label for="free_delivery_threshold" class="form-label">Free Delivery Threshold (LKR)</label>
                <input type="number" id="free_delivery_threshold" name="settings[free_delivery_threshold]" class="form-control" value="{{ $settings['free_delivery_threshold'] ?? 10000 }}" step="100">
